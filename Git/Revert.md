...
**Links**: [[Commit]] | [[Reset]] | [[Cherry-Pick]] | [[Reflog]] | [[Advanced Merging]]

Revert creates a new commit that undoes a previous commit's changes — a safe, history-preserving way to roll back changes on shared branches.
...
**Next**: [[Restore]] — Restore files to previous states
