...
**Links**: [[Internals I]] | [[Internals III]] | [[Branch]] | [[Reflog]]

Branches, tags, and HEAD are all references — pointers into Git's object database. Understanding refs explains how Git tracks state without duplicating data.
...
**Next**: [[Internals III]] — Maintenance and garbage collection
