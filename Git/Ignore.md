...
**Links**: [[Add and Status]] | [[Clean]] | [[Attributes]] | [[LFS]] | [[Best Practices]]

Not every file belongs in version control — build artifacts, dependencies, and secrets should stay out. The .gitignore file tells Git which paths to skip.
...
**Next**: [[Archive]] — Export repositories