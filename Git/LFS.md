...
**Links**: [[Submodules]] | [[Best Practices]] | [[Attributes]]

Git struggles with large binary files because it stores every version in full. Git LFS replaces large files with text pointers and stores the blobs externally.
...
**Next**: [[GPG]] — Signing commits and tags