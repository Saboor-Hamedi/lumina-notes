...
**Links**: [[Add and Status]] | [[Checkout and Switch]] | [[Reset]] | [[Clean]] | [[Diff]]

Restore provides a focused way to discard changes in your working directory or unstage files, without affecting branch pointers or commit history.
...
**Next**: [[Clean]] — Remove untracked files
