...
**Links**: [[Configuration]] | [[Ignore]] | [[LFS]] | [[Diff]]

Not all files behave the same in a repository. .gitattributes defines per-file settings — from line-ending normalization to diff drivers and merge strategies.
...
**Next**: [[Ignore]] — Ignore files with .gitignore