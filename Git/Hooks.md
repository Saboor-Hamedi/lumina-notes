...
**Links**: [[Configuration]] | [[Server Hooks]] | [[Best Practices]] | [[Developer Workflow Automation]]

Git hooks are scripts that run automatically at key points in the Git workflow — from pre-commit validation to post-receive deployment triggers.
...
**Next**: [[Server Hooks]] — Server-side enforcement